...
import ReporteRequisicionPdf from "@/pdf/Almacen/ReporteRequisicionPdf.vue";
export const useReporteRequisicion = (context) => {

    const dataGetRequisicion = ref([])
    const errors = ref([])
    ...
    const printPdf = () => {
        ...
        const opt = {
            ...
            margin: 0.5,
            filename: "REPORTE_REQUISICION_" + moment().format("L"),
