<template>
    <li class="px-3 py-2 rounded-lg mb-0.5 last:mb-0 cursor-pointer" :class="matchPath ? 'bg-[#010b2c]' : ''">
            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center">
                    <svg v-if="stateToMenu" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                        stroke-width="1" class="w-7 h-7  "
                        :class="matchPath ? 'fill-current  text-indigo-600 stroke-black' : 'fill-current text-slate-600'">
