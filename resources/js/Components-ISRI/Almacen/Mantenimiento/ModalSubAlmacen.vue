<template>
    <Modal modal-title="Gestión de Sub Almacen." maxWidth="2xl" :show="ModalIsOpen" @close="$emit('close-modal')">
                    ...
                    <div class="  mb-7 w-full">
                        ...
                        <div class="relative flex h-8 w-full flex-row-reverse ">
                            <Multiselect v-model="idEmpleado" :disabled="loadingEvaluacionRendimiento"
                                @open="prueba2(true)" @close="prueba2(false)" @keydown="prueba()"
        ...
        async function (query) { return await handleEmployeeSearch(query) } : buscarpornombre
...
export default {
    ...
    setup(props) {
        ...
        const nombre = [{ value: 1, label: "Nombre" }]
        idEmpleado.value = 1
        /**
     ...
     */
        ...
        const buscarpornombre = ref(true)
        const prueba2 = (log) => {
        ...
        return { objectEmployee, prueba, prueba2, buscarpornombre, ModalIsOpen, handleEmployeeSearch, idEmpleado, nombreSubAlmacen, guardarSubAlmacen, dataSubAlmacen, nombre }
    }
}
</script>
