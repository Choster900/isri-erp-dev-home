                ...
                <table class="table-auto w-full">
                    ...
                    <tbody>
                        <template v-for="(item, index) in dataGetRequisicion" :key="index">
                            <tr class="border *:text-base font-semibold *:text-center *:hover:bg-slate-200 *:px-2"
                            ...
                            <tr v-show="item.id_tipo_reg_rpt_requisicion == 2"
                            ...
                            <tr class="border *:text-xs *:text-center *:hover:bg-slate-200 *:px-2"
                    ...
                    <tbody v-if="dataGetRequisicion == '' && isLoadinRequest == false">
                        <tr>
                            <td colspan="12">
