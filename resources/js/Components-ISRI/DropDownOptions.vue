    ...
    <div class="relative inline-flex">
        ...
        <transition enter-active-class="transition ease-out duration-200 transform"
            ...
            <div v-show="dropdownOpen"
                class="origin-top-right z-10 absolute top-full min-w-44  py-1.5 rounded shadow-lg  mt-1 right-0">
                <div ref="dropdown" @focusin="dropdownOpen = true" @focusout="dropdownOpen = false"
                    class="bg-white w-40 border border-gray-300 rounded-lg flex flex-col text-sm py-2 px-2 text-gray-500 shadow-lg">
                    <slot>
