            ...
            <div class="flex justify-center items-center mt-5 mb-2 w-full">
                <div class="flex border w-full rounded-lg bg-gray-200">
                    <div class="flex items-center justify-center px-4 py-2">
                        ...
                        <div class="ml-4 flex">
                            <h2 class="font-semibold text-lg">Requerimiento {{ show_request.numero_requerimiento_pago}}-{{show_request.anio_requerimiento_pago }}</h2>
                ...
                <div class="tabla-modal flex-1 ">
                    <table class="w-full">
                        <thead class="bg-[#001c48] text-white">
                            <tr class="">
                                <th class="rounded-tl-lg py-2 border border-l-white">N°</th>
                        ...
                        <tbody class="text-sm divide-y divide-slate-200">
                            <tr v-for="quedan in show_request.quedan" :key="quedan.id_quedan" class="hover:bg-[#141414]/10">
                                ...
                                <td class="text-center whitespace-normal">{{ quedan.proveedor.razon_social_proveedor }}
                                </td>
                                <td class="text-center whitespace-normal text-red-600">{{ quedan.monto_total_quedan }}
                                </td>
                                <td class="text-center whitespace-normal text-red-600">{{ quedan.monto_iva_quedan }}
                                </td>
                                <td class="text-center whitespace-normal text-red-600">{{ quedan.monto_isr_quedan }}
                                </td>
