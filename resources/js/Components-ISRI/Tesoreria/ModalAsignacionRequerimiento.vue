            ...
            <div class="">
                <div class="text-center">
                    <div class=" flex   justify-center pt-2 content-between">
                        ...
                        <div class="px-2 w-52 pb-2">
                            <p class="text-[12px]">Asginar numero requerimiento</p>
                            <div class="relative flex h-8 w-full flex-row-reverse " placeholder="a"
                                :class="{ 'condition-select': dataInputs.id_proveedor == '' }">
                                <Multiselect v-model="dataInputs.id_proveedor" :options="dataForSelectInRow.proveedor"
                                    :searchable="true" @select="getInformationBySupplier($event)" />
                            </div>
                        </div>
                            ...
                            <table class="table-auto mx-auto">
                                <thead>
                                    ...
                                    <tr>
                                        ...
                                        <td class="border-2 border-black bg-[#e6e6e6]" colspan="3">
                                            <input type="text" v-model="dataInputs.numero_acuerdo_quedan" disabled
                                        ...
                                        <td class="border-2 border-black bg-[#e6e6e6]" colspan="8">
                                            <input type="text" v-model="dataInputs.numero_compromiso_ppto_quedan" disabled
                                                class="peer w-full text-sm bg-transparent text-center h-16 border-none px-2 text-slate-900 placeholder-slate-400 transition-colors duration-300 focus:border-none focus:outline-none">
                                        </td>
                                    ...
                                    <tr>
                                        <td class="border-2 border-black" colspan="1">
                                            <div class="relative flex h-8 w-full flex-row-reverse">
                                                <Multiselect v-model="dataInputs.id_acuerdo_compra" v-bind:disabled="true"
                                        ...
                                        <template v-if="row[7]">
                                            ...
                                            <tr>
                                                <template v-for="(cell, cellIndex) in row" :key="cellIndex">
                                                    ...
                                                    <td v-if="cellIndex == 2" class="border-2 border-black bg-[#e6e6e6]">
                                                        {{ cell }}
                                                    </td>
                                                    <td v-else-if="cellIndex == 3" class="border-2 border-black"
                                                        colspan="2">
                                                    ...
                                                    <td v-else-if="cellIndex == 4"
                                                        class="border-2 border-black  bg-[#e6e6e6]">{{ cell }}</td>

                                                    <td v-else-if="cellIndex == 5" colspan="2"
                                                        class="border-2 border-black px-1 bg-[#e6e6e6]">
                                                        {{ cell }}
                                                    </td>
                                                    ...
                                                    <td v-else-if="cellIndex == 6" class="border-2 border-black"
                                                        ...
                                                        <table>
                                                            <tr>
                                                                ...
                                                                <td
                                                                    class="w-full border-2 border-b-black border-x-transparent border-t-transparent  bg-[#e6e6e6]">
                                                                    {{ cell.producto }}
                                                                </td>
                                                            </tr>
                                                            <tr>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="border-2 border-black bg-[#e6e6e6]" colspan="7">
