<template>
    <div class="w-[18.5] h-[12.5cm] ml-[1.5cm] mr-[1.5cm] mt-[0.80cm] mb-[0.6cm]">
                                        ...
                                        <div class="w-full flex flex-col h-full">
                                            ...
                                            <div class="flex justify-center items-start h-[0.5cm] mt-1">
                                                <div class="relative flex w-full flex-row h-full">
                                                    <label for=""
                                                        class="font-bold flex items-center text-[9px] w-2/3 mx-4 mt-0 h-full invisible">
                                                        TOTAL:
                                                    </label>
                                                    <div class="w-1/3 relative mr-1 h-full">
                                                        <span
                                                            class="absolute left-0 top-1/2 transform text-[9px] -translate-y-1/2 font-bold">$</span>
                                                        <div
