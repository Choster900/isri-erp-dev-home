        ...
        <div class="border border-gray-300 rounded p-4 mb-4 mx-auto w-[75%]">
            ...
            <div class="mb-7 md:flex flex-row justify-items-start">
                <div class="mb-4 md:mr-2 md:mb-0 basis-1/2">
                    ...
                    <div class="relative md:w-auto flex">
                        <LabelToInput icon="date" />
                        <flat-pickr
                            class="mr-1 peer text-xs cursor-pointer rounded-r-md border h-8 border-slate-400 px-2 text-slate-900 placeholder-slate-400 transition-colors duration-300 focus:border-[#001b47] focus:outline-none w-full"
