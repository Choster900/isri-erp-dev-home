...
<template>
    ...
    <AppLayoutVue nameSubModule="Tesoreria - Reporte de Facturas">
        ...
        <div class="border border-gray-300 rounded p-4 mb-4 mx-auto w-[75%] bg-white">
            <h2 class="text-lg font-bold mb-4 text-center">Reporte Factura</h2>
            <div class="mb-7 md:flex flex-row justify-items-start">
                <div class="mb-4 md:mr-2 md:mb-0 basis-1/2">
                    ...
                    <div class="relative flex">
                        ...
                        <flat-pickr
                            ...
                            :config="config" v-model="invoice_report.start_date"
                ...
                <div class="mb-4 md:ml-1 md:mb-0 basis-1/2">
                    ...
                    <div class="relative flex">
                        ...
                        <flat-pickr
                            class="peer text-xs cursor-pointer rounded-r-md border h-8 border-slate-400 px-2 text-slate-900 placeholder-slate-400 transition-colors duration-300 focus:border-[#001b47] focus:outline-none w-full"
                            :config="config" v-model="invoice_report.end_date" :placeholder="'Seleccione Fecha Final'" />
                    </div>
                ...
                <div class="mb-4 md:mr-1 md:mb-0 basis-1/3">
                    ...
                    <div class="relative font-semibold flex h-8 w-full flex-row-reverse">
                        <Multiselect placeholder="Seleccione Financiamiento" :searchable="true" :options="financing_sources"
                            v-model="invoice_report.financing_source_id" />
                ...
                <div class="mb-4 md:mr-1 md:mb-0 basis-1/3">
                    ...
                    <div class="relative font-semibold flex h-8 w-full flex-row-reverse">
                        <Multiselect placeholder="Seleccione Proveedor" :searchable="true" :options="suppliers"
                            v-model="invoice_report.supplier_id" />
                        <LabelToInput icon="list" />
                    </div>
                ...
                <div class="mb-4 md:mr-1 md:mb-0 basis-1/3">
                    ...
                    <div class="relative font-semibold flex h-8 w-full flex-row-reverse">
                        <Multiselect placeholder="Seleccione Requerimiento" :searchable="true" :options="requirements"
                            v-model="invoice_report.requirement_id" />
                        <LabelToInput icon="list" />
                    </div>
                    <InputError v-for="(item, index) in errors.requirement_id" :key="index" class="mt-2" :message="item" />
                </div>
            </div>
...
export default {
    ...
    methods: {
        async exportExcel() {
            ...
            await axios.post('/create-invoice-report', this.invoice_report, {
                    responseType: 'blob'
                })
                .then(response => {
                    this.errors = []
        ...
        getDataSelect() {
            axios.get("/get-selects-invoice-reporting")
                .then((response) => {
