...
<template>
    <Head title="Reporte - Retencion IVA" />
    <AppLayoutVue nameSubModule="Tesoreria - Reporte de Retencion IVA">
        ...
        <div class="border border-gray-300 rounded p-4 mb-4 mx-auto w-[75%] bg-white">
            <h2 class="text-lg font-bold mb-4 text-center">Reporte Retencion IVA</h2>
...
export default {
    ...
    methods: {
        async exportExcel() {
            ...
            await axios.post('/create-withholding-iva-report', this.report_data, {
                    responseType: 'blob'
                })
                .then(response => {
                    this.errors = []
                    ...
                    let filename = 'RPT-RETENCION-IVA-' + fecha + '.xlsx';
