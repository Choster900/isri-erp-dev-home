<template>
    ...
    <AppLayoutVue nameSubModule="Compras - Bienes y Servicios" :colorSide="' bg-[#343a40] '">
        ...
        <ModalContrato :propProdAdquisicion="objectProductoAdquisicion" :showModal="shoModalBienesServicios"
...
import ModalContrato from '@/Components-ISRI/UCP/BienesServicios/ModalContrato.vue';
import { useDatatable } from '@/Composables/UCP/BienesServicios/useDatatable';
import Datatable from '@/Components-ISRI/Datatable.vue';
import moment from 'moment';
export default {
    components: { ModalContrato, Datatable },
    props: {
        menu: {
            type: Object,
            default: () => { },
