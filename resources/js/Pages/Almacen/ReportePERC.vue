<template>
    ...
    <AppLayoutVue nameSubModule="Almacen - Reporte Compras" :autoPadding="false" :class="'bg-gray-200'">
        <div class="w-[95%] my-4 h-full mx-auto bg-white border border-gray-300">
            <div class="mb-2 mt-4 md:flex flex-row justify-around mx- items-end gap-2">
                ...
                <div>
                    ...
                    <div class="flex gap-2">
                        <label class="">
                            <input type="radio" value="1" class="peer hidden" name="idTipoPerc"
                                v-model="idTipoPerc" />
                            <div
                                ...
                                <h2 class="font-medium text-gray-700 text-xs">INSUMO</h2>
                        ...
                        <label>
                            <input type="radio" value="2" class="peer hidden" name="idTipoPerc"
                                v-model="idTipoPerc" />
                            <div
                                class="hover:bg-gray-50 flex items-center justify-between px-4 border-2 rounded cursor-pointer text-sm border-gray-200 group peer-checked:border-blue-500">
                                <h2 class="font-medium text-gray-700 text-xs">GASTOS</h2>
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    stroke-width="1.5" stroke="currentColor"
                                    class="w-5 h-7 text-blue-600 invisible group-[.peer:checked+&]:visible">
                                    <path stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <InputError class="mt-2" :message="errors[`idTipoPerc`]" />
            ...
            <div class="flex justify-end px-4 gap-3" v-if="dataReportePerc != ''">
            ...
            <TableReportePERC :dataGetPerc="dataReportePerc" :isLoadinRequest="isLoadinRequest" />
...
import TableReportePERC from "@/Components-ISRI/Almacen/Reportes/TableReportePERC.vue";
import { useReportePERC } from "@/Composables/Almacen/Reportes/useReportePERC.js";
export default {
    components: {
        Head,
        AppLayoutVue,
