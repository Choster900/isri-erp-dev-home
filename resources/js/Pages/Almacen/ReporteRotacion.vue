<template>
    <Head title="Reporte - Rotacion" />

    <AppLayoutVue nameSubModule="Almacen - Reporte Rotación" :autoPadding="false" :class="'bg-gray-200'">
        <div class="w-[95%] my-4 h-full mx-auto bg-white border border-gray-300">
            <div class="mb-2 mt-4 md:flex flex-row justify-around mx- items-end gap-2">
                ...
                <div class="basis-[15%]">
                    <DateTimePickerM v-model="varFilteredInForm.fechaInicial" :showIcon="false" :label="'Fecha inicio'" :placeholder="'Seleccione'" :required="true" />
                    <InputError class="mt-2" :message="errors[`varFilteredInForm.fechaInicial`]" />
                </div>

                <div class="basis-[15%]">
                    <date-time-picker-m v-model="varFilteredInForm.fechaFinal" :showIcon="false" :label="'Fecha fin'" :placeholder="'Seleccione'" :required="true" />
                    <InputError class="mt-2" :message="errors[`varFilteredInForm.fechaFinal`]" />
                </div>

                <div class="mb-4 md:mr-0 md:mb-0 basis-[15%]">
                    <label class="block mb-2 text-[13px] font-medium text-gray-600">Proyecto Financiado <span class="text-red-600 font-extrabold">*</span></label
                  >
                  <div class="relative flex h-[30px] w-full">
                    <Multiselect
                      v-model="varFilteredInForm.idProy"
                      :options="[
                ...
                <div class="mb-4 md:mr-0 md:mb-0 basis-[25%]">
                  <label class="block mb-2 text-[13px] font-medium text-gray-600"
                    >Centro Atencion <span class="text-red-600 font-extrabold">*</span></label
                  >
                  <div class="relative flex h-[30px] w-full">
                    <Multiselect
                      :isSelected="0"
                      :options="[
                        ...
                        {
                          value: 5,
                          label: 'CENTRO DE REHABILITACION PARA CIEGOS EUGENIA DE DUEÑAS',
                        },
                        { value: 6, label: 'UNIDAD DE CONSULTA EXTERNA' },
                        {
                          value: 7,
                          label:
                            'CENTRO DE REHABILITACION INTEGRAL PARA LA NIÑEZ Y LA ADOLESCENCIA',
                        },
                      ...
                      :searchable="true"
                      v-model="varFilteredInForm.idCentro"
                      :noOptionsText="'Lista vacía.'"
                      placeholder="Seleccione"
                    />
                  </div>
                ...
                <div class="mb-4 md:mr-0 md:mb-0 basis-[10%]">
                  <label class="block mb-2 text-[13px] font-medium text-gray-600"
                    >Porcentaje <span class="text-red-600 font-extrabold">*</span></label
                  >
                  <div class="relative flex h-[30px] w-full">
                    <Multiselect
                      v-model="varFilteredInForm.porcentaje"
                      :options="[
                        { value: 0.10, label: '10%' },
                        { value: 0.15, label: '15%' },
                        { value: 0.20, label: '20%' },
              ...
              <TableReporteRotacion :dataReporteInfo="dataGetRotation" :isLoadinRequest="isLoadinRequest" />
            </div>
          </AppLayoutVue>
</template>
...
import { useReporteRotacion } from "@/Composables/Almacen/Reportes/useReporteRotacion.js";
...
import TableReporteRotacion from "@/Components-ISRI/Almacen/Reportes/TableReporteRotacion.vue";
import axios from "axios";

export default {
    components: { Head, AppLayoutVue, DateTimePickerM, DateSelect, TableReporteRotacion },
    props: {
        menu: {
            type: Object,
            default: {},
