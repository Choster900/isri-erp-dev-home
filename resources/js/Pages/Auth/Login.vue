                    ...
                    <div class="flex flex-1 flex-col justify-center space-y-7 max-w-md">
                        <div class="flex flex-col space-y-2 text-center">
                            ...
                            <p class="text-md md:text-xl">
                                Bienvenido al SIGI, el software de planificación institucional (ERP)
                            </p>
                        </div>
                        <div class="flex flex-col max-w-md space-y-5">
                            ...
                            <div class="relative">
                                ...
                                <div class="cursor-pointer no-select absolute inset-y-0 right-0 flex items-center px-4 focus:outline-none"
                                    ...
                                    <svg width="28px" height="28px" viewBox="0 0 24 24" fill="none" v-if="showPassword" class="mr-1"
                                    ...
                                    <svg width="35px" height="35px" viewBox="-2.4 -2.4 28.80 28.80" fill="none" v-else
                            ...
                            <InputError class="mt-2 no-select" :message="form.errors.password" />
