...
<template>
    ...
    <AppLayoutVue nameSubModule="RRHH - Solicitudes Permiso">
        ...
        <PermisoFormato012InternoVue v-if="viewPermission012I" :viewPermission012I="viewPermission012I"
            :permissionToPrint="permissionToPrint" :permits="permits" @cerrar-modal="viewPermission012I = false"
            :stages="stages" @get-table="getPermissionRequests(tableData.currentPage)" />
    ...
    methods: {
        checkApproval(permission) {
            ...
            if (!stage) {
                ...
                if (stage.id_estado_etapa_permiso === 8) {
                    return 3 //Approved
                } else {
                    if (stage.id_estado_etapa_permiso === 9) {
                        return 2 //Rejected
                    }
                }
            }
        ...
        async getPermissionRequests(url = "/get-requests-gerente-general") {
            this.tableData.draw++;
