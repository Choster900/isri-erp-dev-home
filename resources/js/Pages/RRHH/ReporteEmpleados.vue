    ...
    <AppLayoutVue nameSubModule="RRHH - Reporte de Empleados" :autoPadding="false">
        ...
        <div v-if="load != 0 && queryResult.length > 0"> <!-- Titulo del reporte-->
            ...
            <div class="text-[14px] mx-10 my-3 flex justify-between items-center">
                <p class="text-orange-600 font-semibold mr-8">EMPLEADOS <span class="text-gray-500">({{
                    queryResult.length
                        }})</span></p>
                <div class="flex">
                    <div @click="exportExcel(queryResult, computedDependencyInfo, computedTitle, computedDate)"
                        ...
                        <svg class="h-4 w-4 text-green-500" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 26 26" fill="#000000">
                    ...
                    <div @click="generatePDF(queryResult, computedDependencyInfo, computedTitle, computedDate)"
                ...
                <div class="bg-white rounded-lg z-10 modal-slide w-full max-w-2xl max-h-full relative sin-scroll">
                    ...
                    <div class="mb-4 md:flex flex-row justify-items-start mx-4">
                        <div class="mb-4 md:mr-2 md:mb-0 basis-1/2">
                            ...
                            <div class="relative font-semibold flex h-10 w-full flex-row-reverse">
                                ...
                                <div
                                    class="flex items-center px-2 pointer-events-none border rounded-l-md border-gray-300">
                    ...
                    <div class="mb-4 md:flex flex-row justify-center mx-4">
                        <div class="mb-4 md:mr-2 md:mb-0 basis-1/2">
                            ...
                            <InputError v-for="(item, index) in errors.status" :key="index" class="mt-2"
                                :message="item" />
                        </div>
                        <div class="mb-4 md:mr-2 md:mb-0 basis-1/2">
