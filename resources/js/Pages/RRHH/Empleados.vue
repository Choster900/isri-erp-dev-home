                            ...
                            <li v-for="link in links" :key="link.label">
                                <span v-if="(link.label == 'Anterior')"
                                    ...
                                    <div class="flex-1 text-right ml-2">
                                        <a @click="link.url ? getEmployees(link.url) : ''" class=" btn bg-white border-slate-200 hover:border-slate-300 cursor-pointer
                                  text-indigo-500">
                                ...
                                <span class="cursor-pointer mt-2" v-else @click="link.url ? getEmployees(link.url) : ''"
