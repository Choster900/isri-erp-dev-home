                ...
                <div class="space-x-1 text-center">
                  <DropDownOptions>
                    <div class="flex hover:bg-gray-100 py-1 px-2 rounded cursor-pointer"
                      v-if="permits.actualizar == 1 && user.estado_usuario == 1" @click="editUser(user)">
                    ...
                    <div class="flex hover:bg-gray-100 py-1 px-2 rounded cursor-pointer" @click="changeStateUser(user)"
                      v-if="permits.eliminar == 1">
                      <div class="w-8 text-red-900"><span class="text-xs">
                          <svg :fill="user.estado_usuario == 1 ? '#991B1B' : '#166534'" version="1.1" id="Capa_1"
                    ...
                    <div class="flex hover:bg-gray-100 py-1 px-2 rounded cursor-pointer"
                      v-if="permits.actualizar == 1 && user.estado_usuario == 1" @click="changePasswordUser(user)">
                      <div class="w-8 text-green-500  rounded-full">
                        <span class="text-xs">
                          <svg fill="#F97316" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"
                            xmlns:xlink="http://www.w3.org/1999/xlink" width="20px" height="20px"
                            viewBox="0 0 569.16 569.16" xml:space="preserve" stroke="#F97316">
                            <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                            <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                            <g id="SVGRepo_iconCarrier">
                              <g>
