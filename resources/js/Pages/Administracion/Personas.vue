    ...
    <AppLayoutVue>
        <div class="sm:flex sm:justify-end sm:items-center mb-2">
            <div class="grid grid-flow-col sm:auto-cols-max sm:justify-end gap-2">
                <GeneralButton @click="AddInformationPersona()" color="bg-green-700  hover:bg-green-800"
        ...
        <div class="bg-white shadow-lg rounded-sm border border-slate-200 relative">
            <header class="px-5 py-4">
                ...
                <h2 class="font-semibold text-slate-800 pt-1">All People <span class="text-slate-400 font-medium">{{
                    pagination.total
                }}</span></h2>
            </header>
                ...
                <datatable :columns="columns" :sortKey="sortKey" :sortOrders="sortOrders" @sort="sortBy">
                    <tbody class="text-sm divide-y divide-slate-200">
                        <tr v-for="persona in personas" :key="persona.id_persona">
                            ...
                            <td class="px-2 first:pl-5 last:pr-5  whitespace-nowrap w-px">
                                <div class="space-x-1">
                                    <button @click.stop="getInformationPersona(persona.id_persona)"
